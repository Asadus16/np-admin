...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { name: "New Order", href: "/customer/orders/new" },
  ...
  },
  {
    ...
    children: [
      { name: "Profile", href: "/customer/settings" },
      { name: "Payment Methods", href: "/customer/settings/payments" },
      { name: "Billing", href: "/customer/settings/billing" },
    ],
  },
];

export function CustomerSidebar({ isCollapsed, isMobileOpen, onCloseMobile }: CustomerSidebarProps) {
