...
import { Building2, Upload, Mail, Phone, Globe } from "lucide-react";
...
export default function CompanyProfilePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    description: "Professional plumbing services with over 15 years of experience. We specialize in residential and commercial plumbing repairs, installations, and maintenance.",
